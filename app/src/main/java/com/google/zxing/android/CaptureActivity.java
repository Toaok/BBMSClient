...
import com.google.zxing.decode.DecodeImgCallback;
import com.google.zxing.decode.DecodeImgThread;
import com.google.zxing.decode.ImageUtil;
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    public static Intent newIntent(Context packageContext) {
        Intent intent=new Intent(packageContext,CaptureActivity.class);
        return intent;
    }
}
